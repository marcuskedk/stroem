    <footer class="stroem-footer">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-3">
                            <ul>
                                ...
                                <li>
                                    <p>Som medlem af Elinstallatørernes Landsorganistion, ELFO, er vi tilsluttet et ankernævn og en garantiordning.</p>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex justify-content-end">
                                <?php foreach ($getContactInformationResult['some'] as $some_key => $some_item) { ?>
                                    <a class="some-icon ms-2" href="<?=$some_item['link'];?>" target="_blank">
                                        <i class="fa <?=$some_item['icon'];?>"></i>
                                    </a>
                                <?php } ?>
                            </div>
                        </div>
        ...
        <div class="go-to-top">
            <a href="#go-to-top" class="btn btn-stroem"><i class="fa fa-chevron-up"></i></a>
        </div>
